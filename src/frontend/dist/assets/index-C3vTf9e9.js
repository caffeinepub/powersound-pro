...
function App() {
  ...
  const [battery, setBattery] = reactExports.useState(100);
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 420, margin: "0 auto", padding: "10px 12px" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel, { title: "BATTERY — POWER CORE 334 AMP", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#5588aa", fontSize: 9, marginTop: 4 }, children: "Amp power only — not connected to audio signal" })
          ] }),
