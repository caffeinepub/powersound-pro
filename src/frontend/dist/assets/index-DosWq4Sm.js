...
function BookAnimation({ onDone }) {
  reactExports.useEffect(() => {
    const t = setTimeout(onDone, 6e3);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", width: 320, height: 420 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                ...
                width: "50%",
                height: "100%",
                background: "linear-gradient(135deg, #0a1628 0%, #001f5c 50%, #0d2b7a 100%)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                ...
                width: "50%",
                height: "100%",
                background: "linear-gradient(225deg, #0a1628 0%, #001f5c 50%, #0d2b7a 100%)",
                border: "2px solid #00aaff",
...
const EQ_FREQS = [32, 64, 125, 250, 500, 1e3, 2e3, 4e3, 8e3, 16e3];
const EQ31_FREQS = [
  20,
  25,
  31.5,
...
const ENGINE_DEFS = [
  ["lowshelf", 200],
  // Engine 1: shapes bass region
  ["peaking", 700],
  // Engine 2: shapes low-mids
  ["peaking", 3500],
  // Engine 3: shapes high-mids
  ["highshelf", 6e3]
  // Engine 4: shapes highs/air
];
function buildChain(ctx, el) {
  ...
  signalGuardian.attack.value = 3e-3;
  ...
  let eNode = signalGuardian;
  for (const e of engines) {
    eNode.connect(e);
    eNode = e;
  }
  eNode.connect(engineMerge);
  let node = engineMerge;
...
function EQSlider({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: GREEN, fontSize: 9, fontWeight: 700 }, children: value > 0 ? `+${value}` : value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "range",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#aaa", fontSize: 9 }, children: label })
      ]
    }
  );
}
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            children: value > 0 ? `+${value}` : value === 0 ? "0" : value
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
...
function App() {
  const [showBook, setShowBook] = reactExports.useState(true);
  const [file, setFile] = reactExports.useState(null);
  const [isPlaying, setIsPlaying] = reactExports.useState(false);
  const [hasFile, setHasFile] = reactExports.useState(false);
  const [battery, setBattery] = reactExports.useState(0);
  const [commanderOn, setCommanderOn] = reactExports.useState(true);
  const [bass80Freq, setBass80Freq] = reactExports.useState(80);
  const [routeMode, setRouteMode] = reactExports.useState("both");
  const [eqGains, setEqGains] = reactExports.useState(Array(10).fill(0));
  const [eq31Gains, setEq31Gains] = reactExports.useState(Array(31).fill(0));
  const [activePreset, setActivePreset] = reactExports.useState("FLAT");
  const [chipStates, setChipStates] = reactExports.useState(Array(20).fill(true));
  const [healingOn, setHealingOn] = reactExports.useState(true);
  const [restoringOn, setRestoringOn] = reactExports.useState(true);
  const [freezingOn, setFreezingOn] = reactExports.useState(false);
  const [memLog, setMemLog] = reactExports.useState([]);
  const [freqProfile, setFreqProfile] = reactExports.useState("Analyzing...");
  const [engineActivity, setEngineActivity] = reactExports.useState([0, 0, 0, 0]);
  const [engineActive, setEngineActive] = reactExports.useState([
    true,
    true,
    true,
    true
  ...
  const chainRef = reactExports.useRef(null);
  ...
  const initChain = reactExports.useCallback((ctx, el) => {
  ...
  function startAnalyser() {
    ...
    function tick() {
      ...
      if (frameCount % 60 === 0) {
        ...
        const highScore = data.slice(80, 128).reduce((a, b) => a + b, 0) / total;
  ...
  function setEqBand(i, val) {
    ...
    next[i] = val;
    setEqGains(next);
    if ((_a2 = chainRef.current) == null ? void 0 : _a2.eqBands[i]) {
      chainRef.current.eqBands[i].gain.value = val;
    }
  }
  function setEq31Band(i, val) {
    var _a2;
    const next = [...eq31Gains];
    next[i] = val;
    setEq31Gains(next);
    setActivePreset("CUSTOM");
    if ((_a2 = chainRef.current) == null ? void 0 : _a2.eq31Bands[i]) {
      chainRef.current.eq31Bands[i].gain.value = val;
    }
  }
  function applyEq31Preset(name) {
    ...
    if (chainRef.current) {
      gains.forEach((g2, i) => {
        if (chainRef.current.eq31Bands[i]) {
          chainRef.current.eq31Bands[i].gain.value = g2;
        }
      });
    }
    logMem(`31-Band EQ preset: ${name}`);
  }
  function setBassFreq(v) {
    setBass80Freq(v);
  ...
  function setRoute(mode) {
    ...
    if (!chain) return;
    if (mode === "bass") {
      chain.engines[3].frequency.value = 200;
      logMem("ROUTE: Bass Only");
    } else if (mode === "highs") {
      chain.engines[0].frequency.value = 80;
  ...
  const g = commanderOn;
  if (showBook) return /* @__PURE__ */ jsxRuntimeExports.jsx(BookAnimation, { onDone: () => setShowBook(false) });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: "AWARD WINNING NUMBER 1"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#aaccff", fontSize: 10, letterSpacing: 2 }, children: "GERRED PHILLIPS — Engineer / Product Designer — Built Feb 27 2027" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
      ...
      ` }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 420, margin: "0 auto", padding: "10px 12px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#aaccff", fontSize: 9, letterSpacing: 2 }, children: "MASTER CONTROL — ALL SYSTEMS" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel, { title: "BATTERY — POWER CORE 334 AMP", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    ...
                    animation: battery <= 0 ? "chargePulse 1.2s ease-in-out infinite" : "none",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                style: {
                  color: isPlaying ? "#00ff88" : battery <= 0 ? "#ffcc00" : "#5588aa",
                  fontSize: 9,
                  fontWeight: battery <= 0 ? 700 : 400,
                  marginTop: 4,
                  letterSpacing: battery <= 0 ? 1 : 0
                },
                children: isPlaying ? "POWERING AMP + AUDIO SYSTEM — ACTIVE" : battery <= 0 ? "⚡ CHARGE BATTERY TO START" : "AMP POWERED — READY"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel, { title: "MUSIC SOURCE", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                ref: fileInputRef,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "SOUND ENGINES — A+B+C+D CLASS — SIGNAL ONLY", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 },
              children: ENGINE_INFO.map((e, i) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "div",
                              {
                                ...
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(GreenDot, { active: isOn && g }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "button",
                                    {
                                      type: "button",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#5599cc", fontSize: 9 }, children: e.type }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 9 }, children: e.range }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 8, marginTop: 3 }, children: isOn ? "SERIES — SIGNAL ONLY — NO GAIN" : "BYPASSED — ALLPASS" })
                    ]
                  },
                  e.label
                );
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel, { title: "DJ EQUALIZER — 10 BAND — A+B+C+D CLASS — ZERO CLIP", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: { display: "flex", justifyContent: "space-between", gap: 2 },
                children: EQ_FREQS.map((freq, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  EQSlider,
                  {
                    freq,
                    value: eqGains[i],
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      children: "FREQUENCY SHAPING — NO CLIP"
                    }
                  )
                ]
              }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            {
              style: {
                background: "linear-gradient(180deg, #000d1a 0%, #001428 60%, #000c18 100%)",
              ...
              children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            ...
                            children: "31-BAND GRAPHIC EQ"
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 8, marginTop: 1 }, children: "1/3-OCTAVE · PEAKING · Q=1.4 · ZERO GAIN MANDATE" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: ["+12", "+6", "0", "-6", "-12"].map((lbl) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        style: {
                          color: "#224466",
                  ...
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: EQ31_FREQS.map((freq, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Eq31Slider,
                          {
                            freq,
                            value: eq31Gains[i],
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 5 }, children: ["FLAT", "ROCK", "HIP-HOP", "POP"].map((preset) => {
                  const isActive = activePreset === preset;
                  return /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      "data-ocid": preset === "FLAT" ? "eq31.flat_button" : preset === "ROCK" ? "eq31.rock_button" : preset === "HIP-HOP" ? "eq31.hiphop_button" : "eq31.pop_button",
                      onClick: () => applyEq31Preset(preset),
                      style: {
                        flex: 1,
                        background: isActive ? preset === "FLAT" ? BLUE : GREEN : "#001428",
                        border: `1px solid ${isActive ? preset === "FLAT" ? BLUE : GREEN : BORDER}`,
                        ...
                        fontWeight: 900,
                        letterSpacing: 1,
                        boxShadow: isActive ? `0 0 8px ${preset === "FLAT" ? BLUE : GREEN}66` : "none",
                  ...
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 4 }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(GreenDot, { active: g }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: g ? GREEN : "#3366aa", fontSize: 8 }, children: "COMMANDER LINKED" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#224466", fontSize: 8 }, children: "CHAIN: STAB2 → EQ31[0..30] → DEST" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#224466", fontSize: 8 }, children: "NO GAIN" })
                    ]
                  }
                )
              ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "80HZ BASS PROGRAMME", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                style: {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#aaa", fontSize: 10 }, children: "Bass Frequency Drop" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: GREEN, fontSize: 10, fontWeight: 700 }, children: [
                    bass80Freq,
                    "Hz"
                  ] })
                ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#3366aa", fontSize: 9 }, children: "40Hz" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#3366aa", fontSize: 9 }, children: "BASS SHELF — NO GAIN" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#3366aa", fontSize: 9 }, children: "200Hz" })
            ] })
          ] }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "SIGNAL ROUTING — BASS / HIGHS SWITCH", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 6 }, children: ["both", "bass", "highs"].map((mode) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              children: mode === "both" ? "BASS+HIGHS" : mode.toUpperCase()
            },
            mode
          )) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "LOUD BOOSTER 1700 — TITANIUM CLAMP — NO GAIN", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                display: "flex",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center" }, children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        children: "TITANIUM CLAMP ACTIVE"
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 9, marginTop: 2 }, children: "Signal shaper only — zero gain multiplication" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 9 }, children: "Stabilizer 800,000,000 direct line — distortion blocked" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "right" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: BLUE, fontSize: 18, fontWeight: 900 }, children: "1700" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 9 }, children: "RATING" })
                ] })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel, { title: "STABILIZER — 1,600,000,000 TITANIUM STRENGTH", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: GREEN, fontSize: 10, fontWeight: 700 }, children: "STAGE 1" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: BLUE, fontSize: 16, fontWeight: 900 }, children: "800M" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 9 }, children: "GENTLE 2:1" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(GreenDot, { active: g })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: GREEN, fontSize: 10, fontWeight: 700 }, children: "STAGE 2" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: BLUE, fontSize: 16, fontWeight: 900 }, children: "800M" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 9 }, children: "TITANIUM 2:1" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(GreenDot, { active: g })
                      ]
                    }
                  )
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#3366aa", fontSize: 9 }, children: "CORRECTION ONLY — NEVER LIMITS" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: GREEN, fontSize: 10, fontWeight: 700 }, children: "SIGNAL GUARDIAN ACTIVE" })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel, { title: "20 SMART CHIPS — A+B+C+D — PROCESSOR", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                ...
                children: chipStates.map((on, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 9, marginTop: 6 }, children: "Each chip: Control / Monitor / Boost — Zero stutter / Zero clip" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "AUTO FREQUENCY GENERATOR", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                display: "flex",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(GreenDot, { active: isPlaying && g }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: g ? GREEN : "#aaa", fontSize: 11 }, children: "GENERATOR ACTIVE" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 9, marginTop: 2 }, children: "Bass Generator + Highs Generator — Auto-select" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: isPlaying ? freqProfile : "STANDBY"
                  }
                )
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel, { title: "9.0 HEALING — RESTORING — FREEZING", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 9, marginTop: 6 }, children: "300,000 Software Tools — 10 Smart Chips for Healing/Restoring" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "CONTROLLED COMPRESSOR", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                display: "flex",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(GreenDot, { active: g }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: g ? GREEN : "#aaa", fontSize: 11 }, children: "COMPRESSOR ACTIVE" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 9, marginTop: 2 }, children: "Corrects — does not limit — Commander controlled" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "right" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: GREEN, fontSize: 9 }, children: "MEMORY ACTIVE" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 9 }, children: "All actions written" })
                ] })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "DISTORTION MONITOR — SIGNAL GUARDIAN", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                display: "grid",
              ...
              children: [
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#aaa", fontSize: 8 }, children: item.label }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: GREEN, fontSize: 13, fontWeight: 900 }, children: item.value })
                  ]
                },
                item.label
              ))
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "POWER CORE 334 — 5000 UNITS", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                display: "flex",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(GreenDot, { active: battery > 0 && g }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      style: {
                      ...
                      children: "AMP POWERED"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 9, marginTop: 2 }, children: "5000 units — Battery → Amp → App" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "right" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: BLUE, fontSize: 16, fontWeight: 900 }, children: "334" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 9 }, children: "POWER CORE" })
                ] })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "COMMANDER MEMORY — 900,000,000 Mb", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                height: 100,
              ...
              children: memLog.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#3366aa", fontSize: 9 }, children: "Awaiting commands..." }) : memLog.map((m, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
...
Service({
  ...
  "deletePreset": Func([Text], [], []),
  "getActivePreset": Func([], [Opt(Preset)], ["query"]),
  "getAllPresets": Func([], [Vec(Preset)], ["query"]),
  "readPreset": Func([Text], [Preset], ["query"]),
  "setActivePreset": Func([Text], [], []),
  "updatePreset": Func(
    [
      Text,
      Text,
