...
const EQ10_BANDS = [60, 170, 310, 600, 1e3, 3e3, 6e3, 12e3, 14e3, 16e3];
const EQ31_BANDS = [
  20,
  25,
  31.5,
...
const dimText = { color: "#4a6fa5", fontSize: "10px" };
const labelStyle = {
  color: "#7ab3e0",
  fontSize: "10px",
  letterSpacing: "0.1em",
...
function BookAnimation({ onComplete }) {
  const [phase, setPhase] = reactExports.useState("closed");
  reactExports.useEffect(() => {
      ...
      children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    ...
                    width: "50%",
                    height: "100%",
                    background: "linear-gradient(135deg, #0a1628 0%, #0d2050 50%, #0a1628 100%)",
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#1e3a5f", fontSize: "28px" }, children: "◈" })
                  ] })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    ...
                    width: 6,
                    height: "100%",
                    background: "linear-gradient(to bottom, #f0c040 0%, #c09000 50%, #f0c040 100%)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    ...
                    width: "50%",
                    height: "100%",
                    background: "linear-gradient(225deg, #0a1628 0%, #0d2050 50%, #0a1628 100%)",
                    border: "2px solid #f0c040",
                    borderLeft: "none",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    position: "absolute",
                    inset: 0,
                    background: "radial-gradient(ellipse at center, rgba(0,120,255,0.6) 0%, transparent 60%)",
                    opacity: opening ? 1 : 0,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "✦ AWARD WINNING NUMBER 1 AUDIO SYSTEM ✦"
          }
        )
      ]
    }
...
function SignalBar({ active, level }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      style: { display: "flex", gap: 2, alignItems: "flex-end", height: 20 },
      children: [0.2, 0.4, 0.6, 0.8, 1].map((threshold, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
            width: 6,
...
function App() {
  ...
  const [trackName, setTrackName] = reactExports.useState("");
  const [battery, setBattery] = reactExports.useState(savedMemory.battery ?? 0);
  const [batteryCharging, setBatteryCharging] = reactExports.useState(false);
  const [engines, setEngines] = reactExports.useState(
    savedMemory.engines ?? INITIAL_ENGINES
  );
  const [eq10vals, setEq10vals] = reactExports.useState(
    savedMemory.eq10vals ?? new Array(10).fill(0)
  );
  const [eq31vals, setEq31vals] = reactExports.useState(
    savedMemory.eq31vals ?? new Array(31).fill(0)
  );
  const [selectedInstrument, setSelectedInstrument] = reactExports.useState("FLAT");
  const [instrumentMixVals, setInstrumentMixVals] = reactExports.useState({
    BASS: 75,
    DRUMS: 70,
    GUITAR: 65,
    VOCALS: 80,
  ...
  const [bassOn, setBassOn] = reactExports.useState(savedMemory.bassOn ?? true);
  const [commanderOn, setCommanderOn] = reactExports.useState(
    savedMemory.commanderOn ?? true
  );
  const [volume1700, setVolume1700] = reactExports.useState(savedMemory.volume1700 ?? 1700);
  const [loudBoosterVal, setLoudBoosterVal] = reactExports.useState(
    savedMemory.loudBoosterVal ?? 1700
  );
  const [specBars, setSpecBars] = reactExports.useState(new Array(8).fill(0));
  const [freqProfile, setFreqProfile] = reactExports.useState("ANALYZING...");
  const [engineLevels, setEngineLevels] = reactExports.useState([0, 0, 0, 0]);
  ...
  const chargeTimerRef = reactExports.useRef(null);
  const animFrameRef = reactExports.useRef(null);
  const fileRef = reactExports.useRef(null);
  const batteryRef = reactExports.useRef(savedMemory.battery ?? 0);
  ...
  const startAnalyser = reactExports.useCallback(() => {
    ...
    const loop = () => {
      ...
      const hiAvg = data.slice(200).reduce((a, b) => a + b, 0) / (data.length - 200) / 255;
  ...
  const buildGraph = reactExports.useCallback(
    (buffer) => {
      ...
      bassFilter.gain.value = bassOn ? 3 : 0;
      const eq10 = EQ10_BANDS.map((freq, i) => {
      ...
      const eq31 = EQ31_BANDS.map((freq, i) => {
        const f = ctx.createBiquadFilter();
      ...
      const engineFilters = INITIAL_ENGINES.map((e) => {
        const f = ctx.createBiquadFilter();
        f.type = e.type;
      ...
      engineFilters.forEach((ef, i) => {
        var _a2;
        if (((_a2 = engines[i]) == null ? void 0 : _a2.on) !== false) {
          lastEq31.connect(ef);
  ...
  const handlePlay = reactExports.useCallback(async () => {
    ...
    const store = audioRef.current;
    if (((_a2 = store.ctx) == null ? void 0 : _a2.state) === "running" && store.source) {
      try {
        store.source.stop();
      } catch (_) {
      }
  ...
  const toggleEngine = (id) => {
    setEngines(
      (prev) => prev.map((e) => e.id === id ? { ...e, on: !e.on } : e)
    );
  };
  const applyPreset31 = (preset) => setEq31vals([...preset]);
  reactExports.useEffect(() => {
    if (!isPlaying) return;
    const t = setInterval(() => {
      setBattery((prev) => {
  ...
  const batteryColor = battery > 50 ? "#00ff88" : battery > 20 ? "#f0c040" : "#ff4444";
  if (!animDone) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(BookAnimation, { onComplete: () => setAnimDone(true) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", justifyContent: "center", gap: 16 }, children: ["A⁺", "B⁺", "C⁺", "D⁺"].map((cls) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      style: {
                        color: "#f0c040",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: "HIGH-CLASS AUDIO · SRS 22 CHIP · TITANIUM STABILIZER · CHAIN BLOCK"
                    }
                  )
                ]
              }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 12, flexWrap: "wrap" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...ps, flex: "1 1 300px" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...labelStyle }, children: "MUSIC PLAYER" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: trackName || "NO TRACK LOADED"
                  }
                ),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      style: {
                        ...
                        cursor: "pointer",
                        fontSize: 11,
                        boxShadow: isPlaying ? "0 0 10px rgba(0,255,136,0.3)" : "none"
                      },
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...ps, width: 200, flexShrink: 0 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...labelStyle }, children: "POWER CORE 334" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: batteryCharging ? "⚡ CHARGING..." : battery >= 100 ? "✓ FULL CHARGE" : "● STANDBY"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      isPlaying ? "AMP POWERED · ACTIVE" : trackName ? "FILE LOADED · READY" : "AMP POWER · STANDBY",
                      " ",
                      "· MEMORY ✓"
                    ]
                  }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...labelStyle, marginBottom: 8 }, children: "SOUND ENGINES — A⁺B⁺C⁺D⁺ SMART CLASS · MEMORY ACTIVE · ZERO GAIN" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                  ...
                  children: engines.map((eng, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "button",
                                {
                                  ...
                                  style: {
                                    ...
                                    fontSize: 9,
                                    letterSpacing: "0.1em",
                                    boxShadow: eng.on ? "0 0 6px rgba(0,255,136,0.4)" : "none"
                                  },
                                  children: eng.on ? "ON" : "OFF"
                                }
                              )
                            ]
                          }
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "span",
                                {
                                  style: {
                                    color: "#f0c040",
                                    textShadow: "0 0 10px #f0c040, 0 0 20px rgba(240,192,64,0.5)",
                                    fontSize: 14,
                                    fontWeight: "bold",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 6 }, children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...dimText, marginBottom: 4 }, children: "SIGNAL ACTIVITY" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            SignalBar,
                            {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 12, flexWrap: "wrap" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rack-eq-faceplate", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rack-eq-sliders", style: { height: 132 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rack-eq-zeroline" }),
                      EQ10_BANDS.map((freq, i) => {
                        ...
                        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rack-eq-band", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: `rack-eq-db${eq10vals[i] > 0 ? " active-pos" : eq10vals[i] < 0 ? " active-neg" : ""}`,
                              children: eq10vals[i] !== 0 ? (eq10vals[i] > 0 ? "+" : "") + eq10vals[i] : "·"
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rack-v-range-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "input",
                            {
                              ...
                              onChange: (e) => {
                                ...
                                setEq10vals(
                                  (prev) => prev.map((x, j) => j === i ? v : x)
                                );
                              }
                            }
                          ) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rack-eq-freq", children: freq >= 1e3 ? `${freq / 1e3}k` : freq })
                        ] }, freq);
                      })
                    ] })
                  ]
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...ps, flex: "1 1 220px", minWidth: 0 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...labelStyle, marginBottom: 8 }, children: "COMMANDER — MASTER CONTROL" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          children: commanderOn ? "● COMMANDER ON" : "○ COMMANDER OFF"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          style: {
                            ...
                            fontSize: 11,
                            fontWeight: "bold",
                            boxShadow: commanderOn ? `0 0 12px ${commanderColor}66` : "none"
                          },
                          children: commanderOn ? "ON" : "OFF"
                        }
                      )
                    ]
                  }
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: "✦ SRS 22 CHIP"
                        }
                      ),
                      ["MONITOR", "COMMANDER", "STABILIZER"].map((label) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          style: {
                            display: "flex",
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontSize: 9, color: commanderColor }, children: [
                              label,
                              " ACTIVE"
                            ] })
                          ]
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 9, color: "#2a4a6f", lineHeight: 1.6 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "● ZERO CLIPPING" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "● ZERO BACKGROUND NOISE" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "● ANTI-DISTORTION" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "● 20 SMART CHIPS ACTIVE" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...ps, flex: "1 1 220px", minWidth: 0 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...labelStyle, marginBottom: 8 }, children: "STABILIZER" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                    ...
                    children: "800,000,000 + 800,000,000"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...goldText, fontSize: 9, marginBottom: 10 }, children: "✦ TITANIUM GRADE" }),
                [
                  "SIGNAL CORRECTION",
                  "DISTORTION REMOVAL",
                  "SMART CHIP ACTIVE",
                  ...
                  "COMMANDER LINKED",
                  "CHAIN BLOCK WIRED"
                ].map((label) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                      display: "flex",
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 9, color: commanderColor }, children: label })
                    ]
                  },
                  label
                )),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 8, fontSize: 9, color: "#2a4a6f" }, children: "DOES NOT LIMIT SIGNAL · FULL POWER PRESERVED" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 12, flexWrap: "wrap" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...ps, flex: "1 1 160px", minWidth: 0 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...labelStyle }, children: "80Hz BASS PROGRAMME" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: 9, color: "#2a4a6f", lineHeight: 1.6 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "LOWSHELF · 80Hz" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "NATURAL DROP" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "ROCK CONCERT BASS" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...ps, flex: "1 1 180px", minWidth: 0 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...labelStyle }, children: "LOUD BOOSTER 1700" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...goldText, fontSize: 11, marginBottom: 6 }, children: "✦ TITANIUM CLAMP" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { ...goldText, fontSize: 10 }, children: "0" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          style: { color: commanderColor, fontSize: 11, fontWeight: 700 },
                          children: loudBoosterVal
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { ...goldText, fontSize: 10 }, children: "1700" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    ...
                    onChange: (e) => setLoudBoosterVal(Number.parseInt(e.target.value)),
                    style: { width: "100%" }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: ["CHAIN LINKED", "TITANIUM CLAMP", "ZERO DISTORTION"].map(
                      (l) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 8, color: commanderColor }, children: l })
                          ]
                        },
                        l
                      )
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...ps, flex: "2 1 200px", minWidth: 0 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...labelStyle, marginBottom: 0 }, children: "1700 VOLUME CONTROL" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { ...goldText, fontSize: 11 }, children: volume1700 })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "SILENT" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "MAX OUTPUT" })
                    ]
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...ps, flex: "1 1 160px", minWidth: 0 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...labelStyle }, children: "CHAIN BLOCK" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                    ...
                    children: "ALL SYSTEMS CONNECTED"
                  }
                ),
                [
                  "ENGINES",
                  ...
                  "COMMANDER",
                  "SRS 22"
                ].map((sys) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                      display: "flex",
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 8, color: commanderColor }, children: sys })
                    ]
                  },
                  sys
                ))
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...ps }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...labelStyle, marginBottom: 0 }, children: "AUTO FREQUENCY GENERATOR" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        style: {
                        ...
                        children: [
                          "PROFILE: ",
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: greenText, children: freqProfile })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 9, color: "#4a6fa5" }, children: "ANALYZES EVERY 500ms · AUTO-ADJUSTS ENGINES" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: specBars.map((level, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        flex: 1,
                        ...
                        boxShadow: level > 0.1 ? "0 0 8px rgba(0,255,136,0.4)" : "none",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "20Hz" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "250Hz" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "1kHz" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "4kHz" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "20kHz" })
                  ]
                }
              )
            ] }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          children: "POWERSOUND PRO — 31-BAND GRAPHIC EQ"
                        }
                      )
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 4 }, children: ["ROCK", "HIP-HOP", "POP", "FLAT"].map((preset, pi) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
                          "data-ocid": `eq31.button.${pi + 1}`,
                          onClick: () => applyPreset31([ROCK_31, HIPHOP_31, POP_31, FLAT_31][pi]),
                          style: {
                            background: "#0d2050",
                            border: "1px solid #1e5fa5",
                            color: "#7ab3e0",
                          ...
                          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rack-eq-band", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                ...
                                children: eq31vals[i] !== 0 ? (eq31vals[i] > 0 ? "+" : "") + eq31vals[i] : "·"
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rack-v-range-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "input",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "mixer.section", style: { ...ps }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...labelStyle, marginBottom: 0 }, children: "INSTRUMENT MIXER — SET & EQ" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { ...goldText, fontSize: 9 }, children: "A⁺B⁺C⁺D⁺ CHANNEL PROCESSING" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: ["FLAT", "BASS", "DRUMS", "GUITAR", "VOCALS", "KEYS", "SYNTH"].map(
                    (inst) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        style: {
                          display: "flex",
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              ...
                              style: {
                                ...
                                padding: "3px 6px",
                                borderRadius: 3,
                                border: selectedInstrument === inst ? "1px solid #f0c040" : "1px solid #1e3a5f",
                                color: selectedInstrument === inst ? "#f0c040" : "#4a6fa5",
                                background: selectedInstrument === inst ? "#0d2050" : "transparent",
                                boxShadow: selectedInstrument === inst ? "0 0 8px rgba(240,192,64,0.4)" : "none",
                                textShadow: selectedInstrument === inst ? "0 0 6px #f0c040" : "none",
                                userSelect: "none"
                              },
                              children: inst
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "v-range-wrapper", style: { height: 110 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "input",
                            {
                              type: "range",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              ...
                              children: instrumentMixVals[inst] ?? 75
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 8, color: "#2a4a6f", marginTop: 4 }, children: "TAP AN INSTRUMENT TO LOAD ITS EQ CURVE INTO THE 10-BAND EQUALIZER" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
